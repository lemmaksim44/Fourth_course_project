...
document.getElementById('input_name_service_id').value = 'Консультация по авто';
...
function send() {
    ...
    document.getElementById('input_comment_id').value = document.getElementById('auto_description_title_id').innerHTML;
